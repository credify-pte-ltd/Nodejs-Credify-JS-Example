...
#### `GET: /data-receiver/user-existence`

This generates an URL to kick off an OIDC process.

Query parameters:
- `phone_number (string | undefined) (e.g. sha256(843812345678))` 
- `id_number (string | undefined)`
- `id_document (string | undefined)`

This will return whether or not the specified user exists in data receiver's DB.

[Here is its detail](https://developers.credify.one/how-to-use-servicex/be-data-receiver.html#_3-user-existence-api-endpoint).
